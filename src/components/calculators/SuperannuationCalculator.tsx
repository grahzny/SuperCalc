...
const fieldMeta: Record<string, { label: string; prefix?: string; suffix?: string; hint?: string }> = {
  ...
  otherIncome: { label: "Other taxable income", prefix: "$", hint: "RSUs, rent, dividends, interest, etc." },
...
const fieldGroups = [
  ...
  { title: "Income", keys: ["salaryBase", "bonus", "otherIncome"] as (keyof PersonInput)[] },
